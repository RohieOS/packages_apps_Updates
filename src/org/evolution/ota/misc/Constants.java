...
public final class Constants {
    ...
    public static final String PROP_BUILD_DATE = "org.rohie.build_date";
    ...
    static final String PROP_DEVICE = "ro.rohie.device";
    static final String PROP_BUILD_VERSION = "org.rohie.version";
    static final String PROP_VERSION_CODE = "org.rohie.version.prop";
    static final String OTA_URL = "https://raw.githubusercontent.com/RohieOS/official_devices/11/devices/%s/%s.json";
    static final String DOWNLOAD_WEBPAGE_URL = "https://raw.githubusercontent.com/RohieOS/official_devices/11/devices/%s/%s.txt";
    public static final String DOWNLOAD_PATH = "/data/system_updates/";
    static final String EXPORT_PATH = "RohieOS-Updates/";
